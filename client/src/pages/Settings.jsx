...
/* ── Appearance ─────────────────────────────────────────────────────────────
   ...
   itself. Every swatch and tile below paints live, because a description of a
   colour is no use — the only way to choose one is to see it on the app. */
  ...
  return (
    <div className="card">
      <div className="card-head">
        ...
        <button className="card-action" onClick={resetAppearance}>Reset</button>
      </div>
